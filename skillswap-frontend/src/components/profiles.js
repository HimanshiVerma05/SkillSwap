  ...
  return (
    <>
        ...
        <Grid item xs={4}>
          <Box sx={{ minWidth: 120, maxWidth: 250 }}>
            <FormControl fullWidth>
              ...
              <Select value={skillFilter} label="Skill" onChange={handleFilter}>
                <MenuItem key={-1} value="">
                  None
                </MenuItem>
                {Array.from(skillArray).map((_, index) => (
                  <MenuItem key={index} value={skillArray[index].skillId}>
      ...
      <div className="flex items-center flex-col justify-center grow  ">
        {profiles.length === 0 ? (
          <div className="min-h-svh w-full flex items-center justify-center grow">
            No Profiles found
          </div>
        ) : (
          <div>
                  ...
                  <>
                    <div key={profile.id}>
                      <div
                        ...
                        className="bg-teal-300 rounded-md max-w-64 min-w-64"
                      >
